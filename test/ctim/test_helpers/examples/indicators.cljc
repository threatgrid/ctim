...
(def indicator-maximal
  {:id "indicator-10b490f8-7c1d-4c3b-9be3-52a7fa5c5042"
   ...
   :suggested_COAs [{:confidence "High"
                     ...
                     :COA_id "http://example.com/ctia/coa/coa-e8b81cd5-5870-4bec-8adb-e25e28632b59"}]
   :confidence "High"
   :related_indicators [{:indicator_id "http://example.com/ctia/indicator/indicator-10b490f8-7c1d-4c3b-9be3-52a7fa5c5042"
                         :source "source"
                         :relationship "relationship"
                         :confidence "Low"}]
   :related_campaigns [{:confidence "High"
                        :source "source"
                        :relationship "relationship"
                        :campaign_id "http://example.com/ctia/campaign/campaign-7076713c-ca9b-4ad9-8425-f0d8ced45aca"}]
