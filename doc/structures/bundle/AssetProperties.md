...
|[valid_time](#valid_time-validtimevalidtimemdmap34)|[*ValidTime*](./ValidTime.md#map34)|The time range during which the AssetProperties is considered valid.|**Required**|
|[external_ids](#external_ids-string)|[String]| |_Optional_|
|[external_references](#external_references-externalreferenceexternalreferencemdmap33)|[[*ExternalReference*](./ExternalReference.md#map33)]|Specifies a list of external references which refers to non-CTIM information. This property is used to provide one or more URLs, descriptions, or IDs to records in other systems.|_Optional_|
|[language](#language-shortstring)|ShortString|The human language this object is specified in.|_Optional_|
|[properties](#properties-assetpropertyassetpropertymdmap35)|[[*AssetProperty*](./AssetProperty.md#map35)]| |_Optional_|
...
<a id="external_references-externalreferenceexternalreferencemdmap33"></a>
### `external_references` ∷ [[*ExternalReference*](./ExternalReference.md#map33)]
...
<a id="properties-assetpropertyassetpropertymdmap35"></a>
### `properties` ∷ [[*AssetProperty*](./AssetProperty.md#map35)]
...
<a id="valid_time-validtimevalidtimemdmap34"></a>
### `valid_time` ∷ [*ValidTime*](./ValidTime.md#map34)
