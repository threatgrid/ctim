...
| -------- | ---- | ----------- | --------- |
|[observables](#observables-observableobservablemdmap83)|[[*Observable*](./Observable.md#map83)]| |**Required**|
|[type](#type-sensorstring)|SensorString| |**Required**|
|[os](#os-string)|String| |_Optional_|


<a id="observables-observableobservablemdmap83"></a>
### `observables` ∷ [[*Observable*](./Observable.md#map83)]
