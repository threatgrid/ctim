...
|[targets](#targets-targettargetmdmap91)|[[*Target*](./Target.md#map91)]| |**Required**|
...
|[external_references](#external_references-externalreferenceexternalreferencemdmap90)|[[*ExternalReference*](./ExternalReference.md#map90)]|Specifies a list of external references which refers to non-CTIM information. This property is used to provide one or more URLs, descriptions, or IDs to records in other systems.|_Optional_|
...
<a id="external_references-externalreferenceexternalreferencemdmap90"></a>
### `external_references` ∷ [[*ExternalReference*](./ExternalReference.md#map90)]
...
<a id="targets-targettargetmdmap91"></a>
### `targets` ∷ [[*Target*](./Target.md#map91)]
