...
|[valid_time](#valid_time-validtimevalidtimemdmap29)|[*ValidTime*](./ValidTime.md#map29)|The time range during which the Asset is considered valid.|**Required**|
...
<a id="valid_time-validtimevalidtimemdmap29"></a>
### `valid_time` ∷ [*ValidTime*](./ValidTime.md#map29)
