...
|[external_references](#external_references-externalreferenceexternalreferencemdmap81)|[[*ExternalReference*](./ExternalReference.md#map81)]|Specifies a list of external references which refers to non-CTIM information. This property is used to provide one or more URLs, descriptions, or IDs to records in other systems.|_Optional_|
...
<a id="external_references-externalreferenceexternalreferencemdmap81"></a>
### `external_references` ∷ [[*ExternalReference*](./ExternalReference.md#map81)]
