...
|[observable](#observable-observableobservablemdmap85)|[*Observable*](./Observable.md#map85)| |**Required**|
...
|[valid_time](#valid_time-validtimevalidtimemdmap86)|[*ValidTime*](./ValidTime.md#map86)| |**Required**|
|[external_ids](#external_ids-string)|[String]| |_Optional_|
|[external_references](#external_references-externalreferenceexternalreferencemdmap84)|[[*ExternalReference*](./ExternalReference.md#map84)]|Specifies a list of external references which refers to non-CTIM information. This property is used to provide one or more URLs, descriptions, or IDs to records in other systems.|_Optional_|
...
<a id="external_references-externalreferenceexternalreferencemdmap84"></a>
### `external_references` ∷ [[*ExternalReference*](./ExternalReference.md#map84)]
...
<a id="observable-observableobservablemdmap85"></a>
### `observable` ∷ [*Observable*](./Observable.md#map85)
...
<a id="valid_time-validtimevalidtimemdmap86"></a>
### `valid_time` ∷ [*ValidTime*](./ValidTime.md#map86)
