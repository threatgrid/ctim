...
|[valid_time](#valid_time-validtimevalidtimemdmap117)|[*ValidTime*](./ValidTime.md#map117)|The time range during which the AssetProperties is considered valid.|**Required**|
|[external_ids](#external_ids-string)|[String]| |_Optional_|
|[external_references](#external_references-externalreferenceexternalreferencemdmap116)|[[*ExternalReference*](./ExternalReference.md#map116)]|Specifies a list of external references which refers to non-CTIM information. This property is used to provide one or more URLs, descriptions, or IDs to records in other systems.|_Optional_|
|[language](#language-shortstring)|ShortString|The human language this object is specified in.|_Optional_|
|[properties](#properties-assetpropertyassetpropertymdmap118)|[[*AssetProperty*](./AssetProperty.md#map118)]| |_Optional_|
...
<a id="external_references-externalreferenceexternalreferencemdmap116"></a>
### `external_references` ∷ [[*ExternalReference*](./ExternalReference.md#map116)]
...
<a id="properties-assetpropertyassetpropertymdmap118"></a>
### `properties` ∷ [[*AssetProperty*](./AssetProperty.md#map118)]
...
<a id="valid_time-validtimevalidtimemdmap117"></a>
### `valid_time` ∷ [*ValidTime*](./ValidTime.md#map117)
