...
|[valid_time](#valid_time-validtimevalidtimemdmap27)|[*ValidTime*](./ValidTime.md#map27)| |**Required**|
|[actor_refs](#actor_refs-string)|#{String}| |_Optional_|
|[actors](#actors-actoractormdmap6)|#{[*Actor*](./Actor.md#map6)}|a list of `Actor`|_Optional_|
|[asset_mapping_refs](#asset_mapping_refs-string)|#{String}| |_Optional_|
|[asset_mappings](#asset_mappings-assetmappingassetmappingmdmap8)|#{[*AssetMapping*](./AssetMapping.md#map8)}|a list of `AssetMapping`|_Optional_|
|[asset_properties](#asset_properties-assetpropertiesassetpropertiesmdmap9)|#{[*AssetProperties*](./AssetProperties.md#map9)}|a list of `AssetProperties`|_Optional_|
|[asset_properties_refs](#asset_properties_refs-string)|#{String}| |_Optional_|
|[asset_refs](#asset_refs-string)|#{String}| |_Optional_|
|[assets](#assets-assetassetmdmap7)|#{[*Asset*](./Asset.md#map7)}|a list of `Asset`|_Optional_|
|[attack_pattern_refs](#attack_pattern_refs-string)|#{String}| |_Optional_|
|[attack_patterns](#attack_patterns-attackpatternattackpatternmdmap10)|#{[*AttackPattern*](./AttackPattern.md#map10)}|a list of `AttackPattern`|_Optional_|
|[campaign_refs](#campaign_refs-string)|#{String}| |_Optional_|
|[campaigns](#campaigns-campaigncampaignmdmap11)|#{[*Campaign*](./Campaign.md#map11)}|a list of `Campaign`|_Optional_|
|[coa_refs](#coa_refs-string)|#{String}| |_Optional_|
|[coas](#coas-coacoamdmap12)|#{[*COA*](./COA.md#map12)}|a list of `COA`|_Optional_|
|[data_table_refs](#data_table_refs-string)|#{String}| |_Optional_|
|[data_tables](#data_tables-datatabledatatablemdmap24)|#{[*DataTable*](./DataTable.md#map24)}|a list of `DataTable`|_Optional_|
...
|[external_references](#external_references-externalreferenceexternalreferencemdmap5)|[[*ExternalReference*](./ExternalReference.md#map5)]|Specifies a list of external references which refers to non-CTIM information. This property is used to provide one or more URLs, descriptions, or IDs to records in other systems.|_Optional_|
|[feedback_refs](#feedback_refs-string)|#{String}| |_Optional_|
|[feedbacks](#feedbacks-feedbackfeedbackmdmap13)|#{[*Feedback*](./Feedback.md#map13)}|a list of `Feedback`|_Optional_|
|[identity_assertion_refs](#identity_assertion_refs-string)|#{String}| |_Optional_|
|[identity_assertions](#identity_assertions-identityassertionidentityassertionmdmap20)|#{[*IdentityAssertion*](./IdentityAssertion.md#map20)}|a list of `IdentityAssertion`|_Optional_|
|[incident_refs](#incident_refs-string)|#{String}| |_Optional_|
|[incidents](#incidents-incidentincidentmdmap14)|#{[*Incident*](./Incident.md#map14)}|a list of `Incident`|_Optional_|
|[indicator_refs](#indicator_refs-string)|#{String}| |_Optional_|
|[indicators](#indicators-indicatorindicatormdmap15)|#{[*Indicator*](./Indicator.md#map15)}|a list of `Indicator`|_Optional_|
|[judgement_refs](#judgement_refs-string)|#{String}| |_Optional_|
|[judgements](#judgements-judgementjudgementmdmap16)|#{[*Judgement*](./Judgement.md#map16)}|a list of `Judgement`|_Optional_|
...
<a id="sightings-sightingsightingmdmap19"></a>
