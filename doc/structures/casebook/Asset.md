...
|[valid_time](#valid_time-validtimevalidtimemdmap123)|[*ValidTime*](./ValidTime.md#map123)|The time range during which the Asset is considered valid.|**Required**|
...
|[external_references](#external_references-externalreferenceexternalreferencemdmap122)|[[*ExternalReference*](./ExternalReference.md#map122)]|Specifies a list of external references which refers to non-CTIM information. This property is used to provide one or more URLs, descriptions, or IDs to records in other systems.|_Optional_|
...
<a id="external_references-externalreferenceexternalreferencemdmap122"></a>
### `external_references` ∷ [[*ExternalReference*](./ExternalReference.md#map122)]
...
<a id="valid_time-validtimevalidtimemdmap123"></a>
### `valid_time` ∷ [*ValidTime*](./ValidTime.md#map123)
