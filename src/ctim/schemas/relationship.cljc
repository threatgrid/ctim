...
(def RelatedTTPs
  (f/seq-of RelatedTTP))
;; This namespace is is for the old STIX 1.2-like embedding of
;; references to other entities within the source entity.  We are
;; moving away from this model, because it requires the editing of
;; objects and also makes it difficult to add new typs of
;; relationships.
